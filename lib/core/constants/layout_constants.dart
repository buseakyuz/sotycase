...
abstract class LayoutConstants {
  ...
  static const defaultVerticalPadding = EdgeInsets.symmetric(
    vertical: defaultSize,
  );
  static const centralVerticalPadding = EdgeInsets.symmetric(
    vertical: centralSize,
  );
  ...
  // ************* Horizontal Padding ************* //
  static const tinyHorizontalPadding = EdgeInsets.symmetric(
    horizontal: tinySize,
  );
  static const lowHorizontalPadding = EdgeInsets.symmetric(horizontal: lowSize);
  static const defaultHorizontalPadding = EdgeInsets.symmetric(
    horizontal: defaultSize,
  );
  static const centralHorizontalPadding = EdgeInsets.symmetric(
    horizontal: centralSize,
  );
  static const midHorizontalPadding = EdgeInsets.symmetric(horizontal: midSize);
  static const highHorizontalPadding = EdgeInsets.symmetric(
    horizontal: highSize,
  );
  static const largeHorizontalPadding = EdgeInsets.symmetric(
    horizontal: largeSize,
  );
  static const maxHorizontalPadding = EdgeInsets.symmetric(horizontal: maxSize);
  static const ultraHorizontalPadding = EdgeInsets.symmetric(
    horizontal: ultraSize,
  );
  ...
  // ************* Circular Radius ************* //
  static const defaultButtonBorder = BorderRadius.all(
